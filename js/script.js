...
$(function() {
    ...
    $('#dubae').delay(1000).slideDown().delay(2000).slideUp().fadeOut();
    ...
    $('#circle2').css({'height' : '140px', 'width' : '140px', 'background' : 'cyan', 'lineHeight' : '140px', 'textAlign' : 'center', 'margin' : '50px auto', 'color' : 'white'}).addClass('circleShape');
